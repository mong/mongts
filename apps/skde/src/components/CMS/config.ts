...
const atlas = (lang: "no" | "en"): CmsCollection => {
  return {
    ...
    folder: lang === "no" ? "apps/skde/_posts/atlas" : "apps/skde/_posts/en/v2",
    extension: "json",
    format: "json",
    create: true,
    delete: false,
    media_folder:
      lang === "no"
        ? "apps/skde/public/img/no/{{filename}}"
        : "apps/skde/public/img/en/{{filename}}",
    public_folder:
      lang === "no"
              ...
              },
              {
                ...
                fields: [
                  ...
                  },
                  {
                    ...
                    name: "data",
                    widget: "file",
                    media_folder: "/apps/skde/public/data",
                    public_folder: "",
...
export const config: CmsConfig = {
  ...
  media_folder: "apps/skde/public/img",
