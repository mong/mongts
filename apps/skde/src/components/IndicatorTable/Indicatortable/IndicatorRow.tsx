...
import { Collapse, Stack, TableCellProps, Typography } from "@mui/material";
				...
				>
					<Collapse
						...
						onEnter={() => {
							...
							// biome-ignore lint: no-undecleared-variables -- reason: global replace, please state reason here
							element &&
